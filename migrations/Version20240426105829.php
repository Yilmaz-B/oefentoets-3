 ...
 */
final class Version20240426105829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_line ADD product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product_line ADD CONSTRAINT FK_5CFC96574584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_5CFC96574584665A ON product_line (product_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5CFC96574584665A ON product_line');
        $this->addSql('ALTER TABLE product_line DROP product_id');
    }
}
